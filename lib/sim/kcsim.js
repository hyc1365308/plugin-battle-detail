...
function theoreticalASWPower(ship, target, attackType, engagementMod, critStatus, stageSubType) {
...
function theoreticalShellPower(ship, target, attackType, engagementMod, critStatus) {  // power before calculate Armor
    // console.log("theoreticalShellPower", ship, target, attackType, engagementMod, critStatus)

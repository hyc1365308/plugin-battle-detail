...
//------- shared func
var _sim_shared = require('./shared')
isPlayable = _sim_shared.isPlayable

//------- kcEQDATA vars
var _kc_eqdata = require('./kcEQDATA')
EQDATA = _kc_eqdata.EQDATA
EQTDATA = _kc_eqdata.EQTDATA
FITDATA = _kc_eqdata.FITDATA
FITDATAN = _kc_eqdata.FITDATAN

MAINGUNS = _kc_eqdata.MAINGUNS
MAINGUNM = _kc_eqdata.MAINGUNM
MAINGUNL = _kc_eqdata.MAINGUNL
SECGUN = _kc_eqdata.SECGUN
TORPEDO = _kc_eqdata.TORPEDO
FIGHTER = _kc_eqdata.FIGHTER
DIVEBOMBER = _kc_eqdata.DIVEBOMBER
TORPBOMBER = _kc_eqdata.TORPBOMBER
CARRIERSCOUT = _kc_eqdata.CARRIERSCOUT
SEAPLANE = _kc_eqdata.SEAPLANE
SEAPLANEBOMBER = _kc_eqdata.SEAPLANEBOMBER
RADARS = _kc_eqdata.RADARS
RADARL = _kc_eqdata.RADARL
SONARS = _kc_eqdata.SONARS
DEPTHCHARGE = _kc_eqdata.DEPTHCHARGE
ENGINE = _kc_eqdata.ENGINE
TYPE3SHELL = _kc_eqdata.TYPE3SHELL
APSHELL = _kc_eqdata.APSHELL
AAGUN = _kc_eqdata.AAGUN
MIDGETSUB = _kc_eqdata.MIDGETSUB
REPAIR = _kc_eqdata.REPAIR
LANDINGCRAFT = _kc_eqdata.LANDINGCRAFT
AUTOGYRO = _kc_eqdata.AUTOGYRO
ASWPLANE = _kc_eqdata.ASWPLANE
BULGEM = _kc_eqdata.BULGEM
BULGEL = _kc_eqdata.BULGEL
SEARCHLIGHTS = _kc_eqdata.SEARCHLIGHTS
DRUM = _kc_eqdata.DRUM
SRF = _kc_eqdata.SRF
TORPEDOSS = _kc_eqdata.TORPEDOSS
STARSHELL = _kc_eqdata.STARSHELL
FCF = _kc_eqdata.FCF
SCAMP = _kc_eqdata.SCAMP
AAFD = _kc_eqdata.AAFD
WG42 = _kc_eqdata.WG42
MAINGUNXL = _kc_eqdata.MAINGUNXL
PICKET = _kc_eqdata.PICKET
SONARL = _kc_eqdata.SONARL
FLYINGBOAT = _kc_eqdata.FLYINGBOAT
SEARCHLIGHTL = _kc_eqdata.SEARCHLIGHTL
RATION = _kc_eqdata.RATION
OILDRUM = _kc_eqdata.OILDRUM
SEAPLANEFIGHTER = _kc_eqdata.SEAPLANEFIGHTER
LANDINGTANK = _kc_eqdata.LANDINGTANK
LANDBOMBER = _kc_eqdata.LANDBOMBER
INTERCEPTOR = _kc_eqdata.INTERCEPTOR
LANDSCOUT = _kc_eqdata.LANDSCOUT
TRANSPORTITEM = _kc_eqdata.TRANSPORTITEM
SUBRADAR = _kc_eqdata.SUBRADAR
HEAVYBOMBER = _kc_eqdata.HEAVYBOMBER
JETBOMBER = _kc_eqdata.JETBOMBER
JETSCOUT = _kc_eqdata.JETSCOUT
RADARXL = _kc_eqdata.RADARXL
CARRIERSCOUT2 = _kc_eqdata.CARRIERSCOUT2
OTHER = _kc_eqdata.OTHER

B_MAINGUN = _kc_eqdata.B_MAINGUN
B_SECGUN = _kc_eqdata.B_SECGUN
B_RECON = _kc_eqdata.B_RECON
B_RADAR = _kc_eqdata.B_RADAR
B_APSHELL = _kc_eqdata.B_APSHELL
B_SONAR = _kc_eqdata.B_SONAR
B_DEPTHCHARGE = _kc_eqdata.B_DEPTHCHARGE
B_TORPEDO = _kc_eqdata.B_TORPEDO
B_TYPE3SHELL = _kc_eqdata.B_TYPE3SHELL
B_PICKET = _kc_eqdata.B_PICKET
B_DRUM = _kc_eqdata.B_DRUM
B_DEPTHCHARGE2 = _kc_eqdata.B_DEPTHCHARGE2
B_NIGHTFIGHTER = _kc_eqdata.B_NIGHTFIGHTER
B_NIGHTBOMBER = _kc_eqdata.B_NIGHTBOMBER
B_NIGHTBOMBER2 = _kc_eqdata.B_NIGHTBOMBER2
B_NIGHTCREW = _kc_eqdata.B_NIGHTCREW
B_SUBRADAR = _kc_eqdata.B_SUBRADAR
B_OTHER = _kc_eqdata.B_OTHER

A_HAGUN = _kc_eqdata.A_HAGUN
A_AAFD = _kc_eqdata.A_AAFD
A_HAFD = _kc_eqdata.A_HAFD
A_MAINGUNL = _kc_eqdata.A_MAINGUNL
A_TYPE3SHELL = _kc_eqdata.A_TYPE3SHELL
A_AIRRADAR = _kc_eqdata.A_AIRRADAR
A_AAGUN = _kc_eqdata.A_AAGUN
A_GUN = _kc_eqdata.A_GUN
A_XLGUN = _kc_eqdata.A_XLGUN

//------- from kcsim
var _kc_sim = require('./kcsim')
MECHANICS = _kc_sim.MECHANICS
ALLFORMATIONS = _kc_sim.ALLFORMATIONS


//------- from kcSHIPDATA
var _kc_shipdata = require('./kcSHIPDATA')
SHIPDATA = _kc_shipdata.SHIPDATA
SHIPTDATA = _kc_shipdata.SHIPTDATA
...
function Ship(id,name,side,LVL,HP,FP,TP,AA,AR,EV,ASW,LOS,LUK,RNG,planeslots) {
	...
	if (!(typeof SHIPDATA == 'undefined')) {
		for (var key in SHIPDATA[id]) {  //load extra data
			if (['image','EQUIPS','SLOTS'].indexOf(key) == -1) {
                this[key] = SHIPDATA[id][key];
            }
		}
	}
	this.side = side;
    ...
    this.isInstall = (this.type == 'Installation' || this.installtype > 0 || this.isAnchorage);
}
...
Ship.prototype.getFormation = function() {
	...
	return (this.num <= threshold)? _kc_sim.VANGUARD1 : _kc_sim.VANGUARD2;
}
...
Ship.prototype.ASWPower = function() {
    ...
    var equipASW = 0, effEquipASW = 0, hassonar = false, hassonars = false, hasdc = false, hasdc1 = false, hasdc2 = false, equipASWSum = 0;
    if (this.equips) this.equips.forEach((eq) => {
        equipASW = (eq.ASW || 0);
        equipASWSum += equipASW
	...
	this._aswpower = (2*Math.sqrt(this.ASW - equipASWSum)+1.5*effEquipASW+((this.planeasw)? 8 : 13)+(this.improves.Pasw||0)) * synergyMod * synergyMod2;
	// blue bonus join in sqrt(asw) calculation (a little error)

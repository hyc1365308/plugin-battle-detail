...
export const AttackType = {
  ...
  Primary_Torpedo_Radar_CI            : "GTR CI",
  Lookouter_Torpedo_Radar_CI          : "LTR CI",
  Lookouter_Torpedo_CI                : "LTT CI",
  Lookouter_Torpedo_Drum_CI           : "LTD CI",
  Primary_Torpedo_Radar_CI_Double     : "GTR CI double",
  Lookouter_Torpedo_Radar_CI_Double   : "LTR CI double",
  Lookouter_Torpedo_CI_Double         : "LTT CI double",
  Lookouter_Torpedo_Drum_CI_Double    : "LTD CI double",
  Sub_Torpedo_CI                      : "SUB TT CI",
  Sub_Torpedo_Radar_CI                : "SUB TR CI",
  Carrier_Night_CI                    : "CVNCI",
  Carrier_Night_CI_3                  : "CVNCI 3",
  Carrier_Night_CI_2                  : "CVNCI 2",
  Carrier_Night_CI_1                  : "CVNCI 1",
}
...
export const NightAttackTypeMap = {
  ...
  31: AttackType.Sub_Torpedo_Radar_CI,
  32: AttackType.Sub_Torpedo_CI,
  4: AttackType.Primary_Secondary_CI,
  5: AttackType.Primary_Primary_CI,
  6: AttackType.Carrier_Night_CI,
  61: AttackType.Carrier_Night_CI_3,
  62: AttackType.Carrier_Night_CI_2,
  63: AttackType.Carrier_Night_CI_1,
  7: AttackType.Primary_Torpedo_Radar_CI,
  8: AttackType.Lookouter_Torpedo_Radar_CI,
  9: AttackType.Lookouter_Torpedo_CI,
  10: AttackType.Lookouter_Torpedo_Drum_CI,
  11: AttackType.Primary_Torpedo_Radar_CI_Double,
  12: AttackType.Lookouter_Torpedo_Radar_CI_Double,
  13: AttackType.Lookouter_Torpedo_CI_Double,
  14: AttackType.Lookouter_Torpedo_Drum_CI_Double,
  100: AttackType.Nelson_Touch,
  101: AttackType.Nagato_Punch,
  102: AttackType.Mutsu_Splash,
  103: AttackType.Colorado_Fire,
